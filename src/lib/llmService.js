 ...
 */
export async function generateApplicationDocuments(convexClient, userId, universityId, programId, recommenders) {
    try {
...
export function useGenerateDocuments() {
    return async (convexClient, userId, universityId, programId, recommenders) => {
        return generateApplicationDocuments(convexClient, userId, universityId, programId, recommenders);
    };
}
