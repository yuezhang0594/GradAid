...
import { educationValidator, workExperienceValidator, researchExperienceValidator } from './validators';
const schema = defineSchema({
    ...
    applications: defineTable({
        ...
        status: v.union(v.literal("draft"), v.literal("in_progress"), v.literal("submitted"), v.literal("accepted"), v.literal("rejected")),
        ...
        requirements: v.array(v.object({
            type: v.string(),
            status: v.union(v.literal("completed"), v.literal("in_progress"), v.literal("pending"), v.literal("not_started")),
        })),
    })
        .index("by_user", ["userId"])
        .index("by_university", ["universityId"])
    ...
    applicationDocuments: defineTable({
        ...
        userId: v.id("users"),
        title: v.string(),
        type: v.union(v.literal("sop"), v.literal("lor")),
        status: v.union(v.literal("draft"), v.literal("in_review"), v.literal("complete")),
        progress: v.number(),
    ...
    letterOfRecommendations: defineTable({
        ...
        status: v.union(v.literal("pending"), v.literal("in_progress"), v.literal("submitted")),
    ...
    userActivity: defineTable({
        userId: v.id("users"),
        type: v.union(v.literal("document_edit"), v.literal("application_update"), v.literal("lor_request"), v.literal("lor_update"), v.literal("ai_usage")),
